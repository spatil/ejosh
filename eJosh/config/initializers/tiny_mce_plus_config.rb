...
AppConfig.advanced_mce_options = {
    ...
    :theme_advanced_buttons2 => %w{bullist numlist seperator link unlink image media separator cut copy paste pastetext pasteword undo redo separator code hr save newdocument},
